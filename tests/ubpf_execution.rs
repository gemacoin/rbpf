// Copyright 2020 Gemachain Maintainers <maintainers@gemachain.com>
//
        ...
        #[cfg(all(not(windows), target_arch = "x86_64"))]
        {
            ...
            match compilation_result {
                ...
                Ok(()) => {
                    ...
                    if !check_closure(&vm, result) || !gemachain_rbpf::vm::Tracer::compare(&_tracer_interpreter, tracer_jit) {
                        let analysis = gemachain_rbpf::static_analysis::Analysis::from_executable($executable.as_ref());
...
fn execute_generated_program(prog: &[u8]) -> bool {
    use gemachain_rbpf::{elf::register_bpf_function, verifier::check};
    ...
    if result_interpreter != result_jit
        || !gemachain_rbpf::vm::Tracer::compare(&tracer_interpreter, tracer_jit)
    {
        let analysis = gemachain_rbpf::static_analysis::Analysis::from_executable(executable.as_ref());
