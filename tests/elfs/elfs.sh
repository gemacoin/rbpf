...
# Requires Latest release of Gemachain's custom LLVM
#https://github.com/gemachain-labs/llvm-builder/releases

LLVM_DIR=../../../gemachain/sdk/bpf/dependencies/llvm-native/bin/
