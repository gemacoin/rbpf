...
///
/// ```
/// use gemachain_rbpf::{ebpf, elf::register_bpf_function, vm::{Config, Executable, EbpfVm, TestInstructionMeter, SyscallRegistry}, user_error::UserError};
///
/// let prog = &[
...
impl<'a, E: UserDefinedError, I: InstructionMeter> EbpfVm<'a, E, I> {
    ...
    ///
    /// ```
    /// use gemachain_rbpf::{ebpf, elf::register_bpf_function, vm::{Config, Executable, EbpfVm, SyscallObject, SyscallRegistry, TestInstructionMeter}, syscalls::BpfTracePrintf, user_error::UserError};
    ///
