...
///
/// ```
/// use gemachain_rbpf::syscalls::{BpfTimeGetNs, Result};
/// use gemachain_rbpf::memory_region::{MemoryRegion, MemoryMapping};
/// use gemachain_rbpf::vm::{Config, SyscallObject};
/// use gemachain_rbpf::user_error::UserError;
///
...
///
/// ```
/// use gemachain_rbpf::syscalls::{BpfTracePrintf, Result};
/// use gemachain_rbpf::memory_region::{MemoryRegion, MemoryMapping};
/// use gemachain_rbpf::vm::{Config, SyscallObject};
/// use gemachain_rbpf::user_error::UserError;
///
...
///
/// ```
/// use gemachain_rbpf::syscalls::{BpfGatherBytes, Result};
/// use gemachain_rbpf::memory_region::{MemoryRegion, MemoryMapping};
/// use gemachain_rbpf::vm::{Config, SyscallObject};
/// use gemachain_rbpf::user_error::UserError;
///
...
///
/// ```
/// use gemachain_rbpf::syscalls::{BpfMemFrob, Result};
/// use gemachain_rbpf::memory_region::{MemoryRegion, MemoryMapping};
/// use gemachain_rbpf::vm::{Config, SyscallObject};
/// use gemachain_rbpf::user_error::UserError;
///
...
///
/// ```
/// use gemachain_rbpf::syscalls::{BpfSqrtI, Result};
/// use gemachain_rbpf::memory_region::{MemoryRegion, MemoryMapping};
/// use gemachain_rbpf::vm::{Config, SyscallObject};
/// use gemachain_rbpf::user_error::UserError;
///
...
///
/// ```
/// use gemachain_rbpf::syscalls::{BpfStrCmp, Result};
/// use gemachain_rbpf::memory_region::{MemoryRegion, MemoryMapping};
/// use gemachain_rbpf::vm::{Config, SyscallObject};
///
...
/// extern crate time;
///
/// use gemachain_rbpf::syscalls::{BpfRand, Result};
/// use gemachain_rbpf::memory_region::{MemoryRegion, MemoryMapping};
/// use gemachain_rbpf::vm::{Config, SyscallObject};
/// use gemachain_rbpf::user_error::UserError;
///
