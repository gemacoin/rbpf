...
///
/// ```
/// use gemachain_rbpf::syscalls::bpf_time_getns;
/// use gemachain_rbpf::memory_region::MemoryRegion;
...
///
/// ```
/// use gemachain_rbpf::syscalls::bpf_trace_printf;
/// use gemachain_rbpf::memory_region::MemoryRegion;
/// use gemachain_rbpf::user_error::UserError;
///
/// let regions = [MemoryRegion::default()];
...
///
/// ```
/// use gemachain_rbpf::syscalls::gather_bytes;
/// use gemachain_rbpf::memory_region::MemoryRegion;
/// use gemachain_rbpf::user_error::UserError;
///
/// let regions = [MemoryRegion::default()];
...
///
/// ```
/// use gemachain_rbpf::syscalls::memfrob;
/// use gemachain_rbpf::memory_region::MemoryRegion;
/// use gemachain_rbpf::user_error::UserError;
///
...
///
/// ```
/// use gemachain_rbpf::syscalls::sqrti;
/// use gemachain_rbpf::memory_region::MemoryRegion;
/// use gemachain_rbpf::user_error::UserError;
///
/// let regions = [MemoryRegion::default()];
...
///
/// ```
/// use gemachain_rbpf::syscalls::strcmp;
/// use gemachain_rbpf::memory_region::MemoryRegion;
/// use gemachain_rbpf::user_error::UserError;
///
...
/// extern crate time;
///
/// use gemachain_rbpf::syscalls::rand;
/// use gemachain_rbpf::memory_region::MemoryRegion;
/// use gemachain_rbpf::user_error::UserError;
///
/// unsafe {
